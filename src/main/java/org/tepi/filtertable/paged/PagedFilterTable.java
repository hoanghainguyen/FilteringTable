...
public class PagedFilterTable<T extends Container.Indexed & Container.Filterable & Container.ItemSetChangeNotifier>
    ...
    public HorizontalLayout createControls(PagedFilterControlConfig config) {
        ...
        final Button resetFiltersButton = new Button(config.getResetFilters(), new ClickListener() {
            private static final long serialVersionUID = -355520120491283993L;
...
//                Alignment.MIDDLE_LEFT);
        ...
        controlBar.addComponent(resetFiltersButton);
        controlBar.setComponentAlignment(resetFiltersButton, Alignment.BOTTOM_LEFT);
